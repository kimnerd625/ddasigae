  ...
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h3">
        <a href="#the-parser-class">The Parser class</a>
      </div>
...
spec</a>.</p>
<pre><code class="javascript"><span class="hljs-keyword">let</span> acorn = <span class="hljs-built_in">require</span>(<span class="hljs-string">"acorn"</span>);
<span class="hljs-built_in">console</span>.log(acorn.parse(<span class="hljs-string">"1 + 1"</span>, {<span class="hljs-attr">ecmaVersion</span>: <span class="hljs-number">2020</span>}));
</code></pre>
...
11 (2020), 12 (2021), 13 (2022), 14 (2023), or <code>&quot;latest&quot;</code> (the
...
<div class="pilwrap" id="the-parser-class">
  <h3>
    <a href="#the-parser-class" name="the-parser-class" class="pilcrow"></a>
...
<pre><code class="javascript"><span class="hljs-keyword">var</span> acorn = <span class="hljs-built_in">require</span>(<span class="hljs-string">"acorn"</span>);
<span class="hljs-keyword">var</span> jsx = <span class="hljs-built_in">require</span>(<span class="hljs-string">"acorn-jsx"</span>);
<span class="hljs-keyword">var</span> JSXParser = acorn.Parser.extend(jsx());
JSXParser.parse(<span class="hljs-string">"foo(&lt;bar/&gt;)"</span>, {<span class="hljs-attr">ecmaVersion</span>: <span class="hljs-number">2020</span>});
</code></pre>
